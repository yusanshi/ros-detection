...
def detect(np_array):
    ...
    parser.add_argument("--model_def", type=str,
                        default="yolo_e1/config/yolov3.cfg", help="path to model definition file")
    parser.add_argument("--weights_path", type=str,
                        default="yolo_e1/weights/yolov3.weights", help="path to weights file")
    parser.add_argument("--class_path", type=str,
                        default="yolo_e1/data/coco.names", help="path to class label file")
    ...
    parser.add_argument("--img_size", type=int, default=416,
                        help="size of each image dimension") // TODO
...
if __name__ == "__main__":
    detect(np.array(Image.open('test.png')))
